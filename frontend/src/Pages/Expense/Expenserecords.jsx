      ...
      <div className={ExpenserecordCSS.container}>
        <div className={ExpenserecordCSS.form_container}>
          ...
          <form>
            ...
            <div className={ExpenserecordCSS.form_group}>
              <button className={ExpenserecordCSS.btn_retrieve} onClick={handleRetrieveDetails}>
                Retrieve Details
              </button>
            </div>
            <h3 className={ExpenserecordCSS.footer}>Click above to know how much you have spent in the given time period</h3>
          </form>
        </div>
        <div className={ExpenserecordCSS.table_container}>
          <div className={ExpenserecordCSS.filtered_records}>
            ...
            <button className={ExpenserecordCSS.btn_info} onClick={moreinfo}>More info</button>
          </div>
        </div>
      </div>
    </div>
