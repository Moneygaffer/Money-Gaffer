...
import { AppBar, Toolbar, Button, Container, Typography, Grid, Paper, Slide, Zoom } from '@mui/material';
        ...
        <AppBar position="static">
          <Toolbar>
            ...
            <Link to="/howitworks" style={{ textDecoration: 'none' }}>
              <Button color="inherit" style={{ color: 'white' }}>How it works</Button>
            </Link>
            <Button color="inherit">Find savings</Button>
            <Button color="inherit">Contact US</Button>
            <Link to="/blog" style={{ textDecoration: 'none' }}>
              <Button color="inherit" style={{ color: 'white' }}>Blog</Button>
            </Link>
            <div style={{ flexGrow: 1 }}></div>
      ...
      <Container style={{ textAlign: 'center', paddingTop: '50px' }}>
        ...
        <Zoom in timeout={1500}>
          <Typography variant="h6" gutterBottom>
            Welcome to Money Gaffer, your trusted partner in managing finances and achieving financial success.
          </Typography>
        </Zoom>
      </Container>
